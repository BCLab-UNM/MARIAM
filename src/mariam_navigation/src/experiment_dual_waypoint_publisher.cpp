...
public:
    ExperimentWaypointPublisher() : Node("experiment_waypoint_publisher")
    {
        ...
        ross_tf_sub_ = this->create_subscription<tf2_msgs::msg::TFMessage>(
            "/ross/tf", 10, 
            std::bind(&ExperimentWaypointPublisher::ross_tf_callback, this, std::placeholders::_1));
            
        monica_tf_sub_ = this->create_subscription<tf2_msgs::msg::TFMessage>(
            "/monica/tf", 10, 
            std::bind(&ExperimentWaypointPublisher::monica_tf_callback, this, std::placeholders::_1));
